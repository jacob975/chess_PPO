...
class GymChessEnv(gym.Env):
    ...
    def reset(self):
        ...
        len_random_actions = np.random.randint(0, 10) * 2
    ...
    def observe(self, agent):
        ...
        context['observation'] = np.transpose(context['observation'][...,7:20], (2, 0, 1))
        ...
        # TODO: In this case, we want to flip the board so that the agent is always white
        if self.turn == 1:
